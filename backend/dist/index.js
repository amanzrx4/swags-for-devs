...
const reclaim = new reclaim_sdk_1.Reclaim();
...
app.get('/home/repo', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const template = (yield reclaim.connect('github-claim', claimTypes.map((item) => ({
        ...
        templateClaimId: (0, reclaim_sdk_1.generateUuid)(),
    })), callbackUrl)).generateTemplate(callbackId);
    const url = template.url;
    const templateId = template.id;
    try {
        yield pool.query('INSERT INTO submitted_links (callback_id, status, repo, email, template_id, claimTypes) VALUES ($1, $2, $3, $4, $5)', [callbackId, 'pending', repoFullName, emailStr, templateId, claimTypes]);
    }
    catch (e) {
